...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        // Выделение (поиск) требуемых параметров из массива:
    ...
    private static void writeData(String fullName, String dateBirt, Integer numberPhoneInt, Character gender) throws Exception {
        ...
        String path = new File("").getAbsolutePath() + "\\Lesson_3\\Homework\\";
    ...
    // Проверка на невыявленные данные:
    ...
    // Расшифровка метода по проверке данных по количеству (checkLength):
